...
let movies = [
    ...
    },
    {
        ...
        "Country": "USA",
        "Awards": "Nominated for 1 BAFTA Film Award. Another 4 wins & 33 nominations.",
        "Poster": "https://s.kaskus.id/images/2018/01/17/9758122_20180117091355.jpg",
        "Ratings": [{
                "Source": "Internet Movie Database",
                "Value": "7.3/10"
            },
...
function changeFilm(props) {
    bg.style.backgroundImage = `url("${props.Poster}")`
    genre.innerHTML = `${props.Genre};`
    title.innerHTML = `${props.Title};`
    imdb.innerHTML = `IMDb: ${props.imdbRating}`
    descr.innerHTML = props.Plot
